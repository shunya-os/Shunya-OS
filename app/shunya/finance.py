...
FINANCE_ENTITY_TYPES = {
    "invoice": {
        ...
        "icon": "🧾",
        "schema": [
            {"name": "invoice_number", "label": "Invoice No.", "type": "text", "required": True},
            {"name": "customer_name", "label": "Customer Name / Bill To", "type": "text", "required": True},
            {"name": "customer_gstin", "label": "Customer GSTIN", "type": "text"},
            {"name": "customer_address", "label": "Billing Address", "type": "textarea"},
            {"name": "bill_date", "label": "Bill Date", "type": "date", "required": True},
            {"name": "due_date", "label": "Due Date", "type": "date"},
            {"name": "place_of_supply", "label": "Place of Supply", "type": "text"},
            {"name": "item_description", "label": "Item / Service", "type": "textarea", "required": True},
            {"name": "hsn_sac", "label": "HSN/SAC Code", "type": "text"},
            {"name": "quantity", "label": "Quantity", "type": "number"},
            {"name": "rate", "label": "Rate (₹)", "type": "number"},
            {"name": "taxable_value", "label": "Taxable Value (₹)", "type": "number", "required": True},
            {"name": "cgst_pct", "label": "CGST %", "type": "number"},
            {"name": "sgst_pct", "label": "SGST %", "type": "number"},
            {"name": "igst_pct", "label": "IGST %", "type": "number"},
            {"name": "cgst_amount", "label": "CGST Amt (₹)", "type": "number"},
            {"name": "sgst_amount", "label": "SGST Amt (₹)", "type": "number"},
            {"name": "igst_amount", "label": "IGST Amt (₹)", "type": "number"},
        ...
        "layout": "table",
        "searchable_fields": ["invoice_number", "customer_name", "customer_gstin"],
    },
    "expense": {
        "label": "Expense",
        "icon": "💸",
