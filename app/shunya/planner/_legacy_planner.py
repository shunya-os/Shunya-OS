...
<h1 style="color:#2563eb">AI@panchi.club — Travel Proposal</h1>
...
<p style="color:#6b7280;font-size:12px;margin-top:24px">Generated by AI@panchi.club · Panchi Club Travel OS</p>
</body></html>"""
    ...
    def generate_proposal_teach(self, plan: ItineraryPlan) -> str:
        ...
        lines.append("")
        lines.append("---")
        lines.append(f"*Generated by AI@panchi.club · I'm here to help you make better travel decisions*")
        return "\n".join(lines)
