...
from sqlalchemy import Column, Integer, String, Boolean, DateTime, ForeignKey, Text, Enum as SAEnum, Index
...
# ── Legacy Workspace Experience Framework (backward compat) ────────────
# Kept for test backward compatibility. These will migrate to the new
# CapabilityPolicy model in a future consolidation pass.
