...
```
CURRENT_WORKSTREAM=FCR-01.1
STATUS=SYSTEMIC_REMEDIATION_REQUIRED
NEXT_SUBMILESTONE=FCR-02_CONSOLIDATED_REMEDIATION
...
LAST_COMMIT_SHA=272dbad
LAST_CI_STATUS=GREEN
LAST_CI_RUN=33474695911
LAST_PRODUCTION_SHA=272dbad
LAST_DEPLOY_DATE=2026-09-01
LAST_VERIFIED_SHA=272dbad
...
DIRECTIVES_REGISTERED=ZGC-PR-15_(CLOSED);ZGC-PR-16A_(ANALYZED);ZGC-PR-17_(CLOSED);ZGC-FINAL-CONVERGENCE-01_(CLOSED);FCR-01.1_(COMPLETED)

KNOWN_ORPHAN_ENGINE_COUNT=8
...
MODE=FINAL_CERTIFICATION_READINESS
CONSTRUCTION_FREEZE=TRUE
CURRENT_GATE=FCR-01.1

G0=VERIFIED
G1=NOT_CERTIFIED_(4_object_stores_3_identity_tables)
G2=NOT_CERTIFIED
G3=CONVERGED
G4=NOT_CERTIFIED
G5=NOT_CERTIFIED
