...
class RelationshipIntelligenceRuntime:
    ...
    def register_execution_actions(self, execution_runtime: Any) -> None:
        """Register relationship actions with the Execution Runtime.

        This integrates UCP-02 with SHUNYA's adaptive execution layer.
        Actions registered here become available for scheduling, automation,
        ...
        execution_runtime.register_action(
            action_id="relationship.assess_health",
            contract=ActionContract(
                action_id="relationship.assess_health",
                description="Assess and update relationship health for a profile",
                input_schema={
                    "type": "object",
                    "properties": {
            ...
            handler=self.assess_relationship_health,
        )

        # Action: get recommendations
        execution_runtime.register_action(
            action_id="relationship.get_recommendations",
            contract=ActionContract(
                action_id="relationship.get_recommendations",
                description="Get actionable recommendations for a relationship",
                input_schema={
                    "type": "object",
                    "properties": {
                        "profile_id": {"type": "string"},
        ...
        # Action: record communication
        execution_runtime.register_action(
            action_id="relationship.record_communication",
            contract=ActionContract(
                action_id="relationship.record_communication",
                description="Record a communication event",
                input_schema={
                    "type": "object",
                    "properties": {
                        "profile_id": {"type": "string"},
                    ...
                    "required": ["profile_id", "channel"],
                },
                output_schema={"type": "object"},
            ),
            handler=lambda **kw: self.record_communication(**kw) and None,
        )
