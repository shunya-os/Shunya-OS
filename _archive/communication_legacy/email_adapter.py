"""Email Adapter — GUARDRAILED: No direct sends allowed.
...
Direct calls to email_adapter.send() will fail loudly.
"""
...
GUARDRAIL_MESSAGE = (
    "BLOCKED: Direct email send via email_adapter.send() is DISABLED. "
