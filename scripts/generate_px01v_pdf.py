#!/usr/bin/env python3
"""Convert PX-01V report to PDF."""
import markdown, os, subprocess, sys

AUDIT_DIR = "/home/shunya-deploy/shunya_os/audit"
MD = "/home/shunya-deploy/shunya_os/PX-01V.md"
PDF = os.path.join(AUDIT_DIR, "px-01v.pdf")
TITLE = "PX-01V — Visitor Experience Verification"
...
pre { background: #f2efe9; padding: 10px; border-radius: 4px; }
strong { color: #8b3a2a; }
</style>"""
