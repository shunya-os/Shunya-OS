#!/usr/bin/env python3
"""Convert WVR-001A to a styled PDF for public sharing."""
import markdown, os, subprocess, sys

AUDIT_DIR = "/home/shunya-deploy/shunya_os/audit"
MD = "/home/shunya-deploy/shunya_os/WVR-001A.md"
PDF = os.path.join(AUDIT_DIR, "wvr-001a.pdf")
TITLE = "WVR-001A — Wave Verification Addendum (Dead Code Closure)"
