...
class TestDocumentIngestion:
    ...
    def test_ingest_creates_evidence(self, client, auth_headers):
        ...
        client.post("/api/v1/documents", headers=auth_headers, json={
...
class TestDocumentSearch:
    ...
    def test_search_documents(self, client, auth_headers):
        ...
        r1 = client.post("/api/v1/documents", headers=auth_headers, json={
            "title": "invoice_001.pdf", "content": "Invoice content",
        })
        r2 = client.post("/api/v1/documents", headers=auth_headers, json={
        ...
        resp = client.get("/api/v1/documents/search?classification=invoice", headers=auth_headers)
        data = resp.get_json()
...
class TestDocumentContext:
    ...
    def test_context_not_found(self, client, auth_headers):
        """Non-existent document returns 404."""
        resp = client.get("/api/v1/documents/99999/context", headers=auth_headers)
        assert resp.status_code == 404
